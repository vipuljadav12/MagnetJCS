...
<form id="frm_import" method="post" action="{{url("/admin/Availability/import/store")}}" enctype="multipart/form-data">
{{  csrf_field() }}
    <div class="form-list">
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <a href="{{url('admin/Availability/import/template')}}" title="" class="btn btn-secondary mt-10">Download Template</a>
        </div>
    </div>
    <div class="card shadow">
