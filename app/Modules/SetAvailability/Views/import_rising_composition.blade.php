...
@section("title")
    Import Rising Composition | {{config('app.name',env("APP_NAME"))}}
@endsection
@section('styles')
    <style type="text/css">
        .error{
...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Import Rising Composition</div>
        <div class=""><a href="{{url("/admin/Availability")}}" class="btn btn-sm btn-secondary" title="">Back</a></div>
    </div>
</div>
<form id="frm_import" method="post" action="{{url("/admin/Availability/import_rising_composition/store")}}" enctype="multipart/form-data">
{{  csrf_field() }}
    <div class="form-list">
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <a href="{{url('admin/Availability/import_rising_composition/template')}}" title="" class="btn btn-secondary mt-10">Download Template</a>
        </div>
    </div>
    <div class="card shadow">
