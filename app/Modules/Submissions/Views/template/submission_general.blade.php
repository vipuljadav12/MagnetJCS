<style type="text/css">
    ...
    #wrapperloading {z-index:  9999 !important;}
</style>
<div class="">
        ...
        <div class="row">
            ...
            <div class="col-12 col-xl-6">
                    ...
                    <div class="card-body">
                        ...
                        @foreach (getChoiceAry() as $choicekey => $choicetxt)
                                    ...
                                    <select class="form-control custom-select choice_selection" name="{{$choicetxt}}_choice" id="{{$choicetxt}}_choice">
                                        ...
                                        @foreach($applicationPrograms as $key=>$applicationProgram)
                                            @php
                                                ...
                                                echo $submission->next_grade . " == ".$applicationProgram->grade_name."<BR>";
                                            @endphp
                            ...
                            <div class="form-group row">
                                ...
                                @if($submission->{$choicetxt.'_sibling'} != '')
                        ...
                        @if($submission->awarded_school != "" && in_array($submission->submission_status, ["Offered", "Offered and Accepted"]))
                            <div class="form-group row">
                ...
                @if(!empty($manual_email))
                        ...
                        @if(!empty($offer_data) && $offer_data->offer_slug != "" && !in_array($submission->submission_status, array('Active', 'Pending', 'Application Withdrawn', 'Offered and Accepted', 'Auto Decline')))
                            <div class="card shadow">
                                <div class="card-header">Offered</div>
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="control-label col-9 col-md-9">Offered Link for JEFCO Admin [Offline] : </label>
                ...
                @if($submission->mcp_employee == "Yes") 
                <div class="card shadow">
                    <div class="card-header">JEFCO Employee Status</div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="control-label col-9 col-md-9">JEFCO Employee Verification Status : </label>
                        ...
                        <div class="form-group row">
                            <label class="control-label col-9 col-md-9">JEFCO Magnet Program Employee Status : </label>
                            <div class="col-3 col-md-3 text-right">
