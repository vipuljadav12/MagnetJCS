...
@section('title') District Configuration | {{config('app.name',env("APP_NAME"))}} @endsection
@section('styles')
<style type="text/css">
    .error {
        color: red;
                ...
                <div class="">
                    <form id="frm_index" action="{{url('admin/DistrictConfiguration/store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <label class="control-label">Contract Accept Screen : </label>
                                <div class="row">
                                    <div class="col-md-12">
                                        <textarea class="form-control" id="editor02" name="contract_accept_screen">
                                                {!! ($contract_accept_screen ? $contract_accept_screen : '') !!}
                                            </textarea>
                                    </div>
                                </div>
                            </div>
...
<div id="wrapperloading" style="display:none;">
    <div id="loading"><i class='fa fa-spinner fa-spin fa-4x'></i> <br> API Successfully Started<br>It will take approx 1 minute to bring student record. </div>
</div>
