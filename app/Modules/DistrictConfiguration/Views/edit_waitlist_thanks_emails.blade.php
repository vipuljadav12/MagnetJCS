...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Edit Waitlist Final Confirmation Email</div>
    </div>
</div>
                ...
                <ul class="nav nav-tabs custom-nav-tabs" id="myTab2">
                            ...
                            <div class="tab-content tab-validate  bordered" id="myTab2Content">
                                <div class="tab-pane fade show active" id="accept-email">
                                     <form class="" action="{{url('admin/DistrictConfiguration/saveWaitlistEditEmail')}}" method="POST" onsubmit="return ValidateForm('waitlist_offer_accepted')">
                                        {{csrf_field()}}
                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="{{url('/admin/DistrictConfiguration/preview/thanks/email/waitlist_offer_accepted')}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="waitlist_offer_accepted_mail_subject" id="waitlist_offer_accepted_mail_subject" value="{{$offer_accepted_mail_subject->value ?? ''}}">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor01" name="waitlist_offer_accepted_mail_body">
                                ...
                                <div class="tab-pane fade" id="declined-email">
                                     <form class="" action="{{url('admin/DistrictConfiguration/saveWaitlistEditEmail')}}" method="POST" onsubmit="return ValidateForm('waitlist_offer_declined')">
                                        {{csrf_field()}}
                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="{{url('/admin/DistrictConfiguration/preview/thanks/email/waitlist_offer_declined')}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="waitlist_offer_declined_mail_subject" id="waitlist_offer_declined_mail_subject" value="{{$offer_declined_mail_subject->value ?? ''}}">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            <label class="control-label">Mail Body : </label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor02" name="waitlist_offer_declined_mail_body">
                                ...
                                <div class="tab-pane fade" id="waitlisted-email">
                                      <form class="" action="{{url('admin/DistrictConfiguration/saveWaitlistEditEmail')}}" method="POST" onsubmit="return ValidateForm('waitlist_offer_waitlisted')">
                                        {{csrf_field()}}
                                        <div class="form-group col-12">
	                                        <label style="width: 100%">Mail Subject : <a href="{{url('/admin/DistrictConfiguration/preview/thanks/email/waitlist_offer_waitlisted')}}" target="_blank" class="btn btn-success" style="float: right !important;">Preview</a></label>
	                                        <div class="">
	                                            <input type="text" class="form-control" name="waitlist_offer_waitlisted_mail_subject" id="waitlist_offer_waitlisted_mail_subject" value="{{$offer_waitlisted_mail_subject->value ?? ''}}">
	                                        </div>
	                                    </div>
                                        <div class="form-group col-12">
                                            <label class="control-label">Mail Body : </label>
                                            <div class="row">
                                                <div class="col-md-12">
                                                     <textarea class="form-control" id="editor03" name="waitlist_offer_waitlisted_mail_body">
