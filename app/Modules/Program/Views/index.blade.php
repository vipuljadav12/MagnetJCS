...
@section('title')Program Master  | {{config('app.name',env("APP_NAME"))}}  @endsection
@section('content')
                ...
                <table id="datatable" class="table table-striped mb-0">
                    ...
                    @forelse($programs as $key=>$program)
                        <tr>
                            ...
                            <td class="text-center"><input id="{{$program->id}}" type="checkbox" class="js-switch js-switch-1 js-switch-xs status" data-size="Small" @if($program->status == 'Y') checked @endif /></td>
