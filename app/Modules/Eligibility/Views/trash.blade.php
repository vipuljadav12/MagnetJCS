    ...
    @section('styles')
        ...
        <link
            href="{{ asset('resources/assets/admin/plugins/DataTables/Responsive-2.2.5/css/responsive.bootstrap4.min.css') }}"
            rel="stylesheet" type="text/css" />
        <!-- Sweet Alert -->
        <link href="{{ url('resources/assets/admin/plugins/sweet-alert2/sweetalert2.min.css') }}" rel="stylesheet" type="text/css">
    @endsection
    @section('content')
                                ...
                                @foreach ($eligibilities as $key => $eligibility)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('admin/Eligibility/restore', $eligibility->id) }}"
                                                class="font-18 ml-5 mr-5" title=""><i class=" fas fa-undo"></i></a>
                                    </tr>
                                @endforeach
                            @endif
                        </tbody>
