...
@section('title')Preliminary Selection | {{config('app.name',env("APP_NAME"))}} @endsection
@section('content')
<style type="text/css">
...
@section('scripts')
    ...
    <script type="text/javascript">
         $('#process_preliminary').click(function(event) {
            ...
            $("#wrapperloading").show();
            $.ajax({
                url:'{{ url('/admin/Preliminary/Processing/calculate')}}',
                type:"POST",
         ...
         $('#commit_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'{{ url('/admin/Preliminary/Processing/commit')}}',
                type:"POST",
                data: {"_token": "{{csrf_token()}}", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
         ...
         $('#rollback_preliminary').click(function(event) {
            $("#wrapperloading").show();
            $.ajax({
                url:'{{ url('/admin/Preliminary/Processing/rollback')}}',
                type:"POST",
                data: {"_token": "{{csrf_token()}}", "thresold_val": $("#thresold_val").val()},
                success:function(response){
                    $("#wrapperloading").hide();
