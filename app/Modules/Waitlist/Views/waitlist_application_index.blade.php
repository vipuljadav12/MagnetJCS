...
@section('title')Waitlist Edit Communcation | {{config('app.name',env("APP_NAME"))}} @endsection
@section('content')
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            <div class="page-title mt-5 mb-5">Waitlist Edit Communication</div></div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $("#selectform_settings").click(function()
    {
        ...
        document.location.href = "{{url('/admin/Waitlist/EditCommunication/application/')}}/"+$("#form_field").val();
    })
