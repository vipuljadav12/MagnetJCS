        ...
        <div class="card shadow">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="">
                        <input type="text" onblur="checkStudentID(this)" class="form-control" name="stateID"
                            placeholder="Student ID (10 Digit)" value="{{ old('stateID') }}">
                        <span class="d-none">Checking Student ID <img
                                src="{{ url('/resources/assets/front/images/loader.gif') }}"></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" name="first_name" id="first_name"
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" name="last_name" id="last_name"
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" name="admin"
                            value="{{ old('admin') }}"></div>
        ...
        <div class="box content-header-floating" id="listFoot">
            <div class="row">
                <div class="col-lg-12 text-right hidden-xs float-right">
                    <button type="submit" class="btn btn-warning btn-xs" name="submit" value="Save" title="Save"><i
                    ...
                    <a class="btn btn-danger btn-xs" href="{{ url('/admin/GiftedStudents') }}" title="Cancel"><i
