...
@section('content')
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="">
                <a href="{{ url('admin/GiftedStudents/import') }}" class="btn btn-sm btn-success"
                    title="Import Gifted Students">Import Gifted Students</a>
                <a href="{{ url('admin/GiftedStudents/create') }}" class="btn btn-sm btn-secondary" title="">Add
                    Gifted Student</a>
            </div>
        </div>
    </div>
                        ...
                        @foreach ($data as $key => $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" onclick="deletefunction({{ $value->id }})"
