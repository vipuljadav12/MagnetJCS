        ...
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="">
                @if (checkPermission(Auth::user()->role_id, 'Configuration/create') == 1)
                    <a href="{{ url('admin/Configuration/create') }}" class="btn btn-sm btn-secondary" title="Add Text">Add
                        Text</a>
                @endif
            </div>
        </div>
                        ...
                        @foreach ($msgs as $key => $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('admin/AlertMsg/edit', $value->id) }}" class="font-18 ml-5 mr-5"
