        ...
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            ...
            <div class="">
                @if (Session::get('district_id') != 0)
                    <a href="{{ url('admin/Priority/create') }}" class="btn btn-sm btn-secondary" title="">Add
                        Priority</a>
                @endif
                            ...
                            @foreach ($priorities as $priority)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('admin/Priority/edit/' . $priority->id) }}" class="font-18 ml-5 mr-5"
                                            title=""><i class="far fa-edit"></i></a>
                                        <a href="javascript:void(0)" onclick="deletefunction({{ $priority->id }})"
