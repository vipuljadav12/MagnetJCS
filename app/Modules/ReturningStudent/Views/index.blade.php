...
<div class="card shadow">
    <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
        <div class="page-title mt-5 mb-5">Import Returning Students</div>
    </div>
</div>
<form id="frm_import" method="post" action="{{url($module_url.'/store')}}" enctype="multipart/form-data">
{{  csrf_field() }}
    <div class="form-list">
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <a href="{{url($module_url.'/download/sample')}}" title="" class="btn btn-secondary mt-10">Download Template</a>
        </div>
    </div>
    <div class="card shadow">
