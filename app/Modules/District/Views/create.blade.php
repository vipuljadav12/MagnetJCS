...
@section('title')
    Add District | {{ config('app.name', env('APP_NAME')) }}
@endsection
@section('content')
    <div class="card shadow">
        <div class="card-body d-flex align-items-center justify-content-between flex-wrap">
            <div class="page-title mt-5 mb-5">Add District</div>
            <div class=""><a href="{{ url('admin/District') }}" class="btn btn-sm btn-secondary" title="">Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ url('admin/District/store') }}" method="post" name="add_district" enctype= "multipart/form-data">
        ...
        <div class="">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item"><a class="nav-link active" id="tabbing1-tab" data-toggle="tab" href="#tabbing1"
                        role="tab" aria-controls="tabbing1" aria-selected="true">General</a></li>
                <li class="nav-item"><a class="nav-link" id="tabbing2-tab" data-toggle="tab" href="#tabbing2" role="tab"
                        aria-controls="tabbing2" aria-selected="true">API</a></li>
                <li class="nav-item"><a class="nav-link" id="tabbing3-tab" data-toggle="tab" href="#tabbing3" role="tab"
                        aria-controls="tabbing3" aria-selected="true">Settings</a></li>
            </ul>
                        ...
                        <div class="row">
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"name="name"
                                                    value="{{ old('name') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control" name="short_name"
                                                    value="{{ old('short_name') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control" name="address"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control" name="city"
                                                    value="{{ old('city') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control" name="state"
                                                    value="{{ old('state') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control" id="zipcode"
                                                    name="zipcode" value="{{ old('zipcode') }}" maxlength="6"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-7"><input type="file" class="form-control"
                                                        id="district_logo" name="district_logo"
                                                        value="{{ old('district_logo') }}" accept="image/*"></div>
                                                <div class="col-12 col-md-5">
                                                    <div>
                                                        <img src="{{ url('/resources/assets/admin/images/spacer-logo.png') }}"
                                                            alt="Logo" title="" width="400"
                                                            id="district_logo_img" class="img-thumbnail mr-3">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-7"><input type="file" class="form-control"
                                                        name="magnet_program_logo"
                                                        value="{{ old('magnet_program_logo') }}" accept="image/*"></div>
                                                <div class="col-12 col-md-5">
                                                    <div>
                                                        <img src="{{ url('/resources/assets/admin/images/spacer-logo.png') }}"
                                                            alt="Logo" title="" width="400"
                                                            id="magnet_prog_img" class="img-thumbnail mr-3">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-end"><input type="text"
                                                    class="form-control" id="district_slug" name="district_slug"
                                                    value="{{ old('district_slug') }}">.{{ Request::getHost() }}</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <div class="input-group mb-3">
                                                    <input id="cp2" type="text" class="form-control"
                                                        value="{{ old('theme_color') }}" name="theme_color"
                                                        maxlength="7">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text"><i id="chgcolor"
                                                                class="color-box"
                                                                style="background-color: #5c6771;"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="control-label">District Magnet Program Point of Contact :
                                            </label>
                                            <div class=""><input type="text" class="form-control"
                                                    name="magnet_point_contact"
                                                    value="{{ old('magnet_point_contact') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    name="magnet_point_contact_title"
                                                    value="{{ old('magnet_point_contact_title') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="email" class="form-control"
                                                    name="magnet_point_contact_email"
                                                    value="{{ old('magnet_point_contact_email') }}"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    name="magnet_point_contact_phone"
                                                    value="{{ old('magnet_point_contact_phone') }}"></div>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="">
                                            ...
                                            @endphp
                                            <select class="form-control custom-select" name="district_timezone"
                                                id="district_timezone">
                                                @foreach ($timezones as $key => $value)
                                                    <option value="{{ $key }}"
                                                        @if ($key == $select_timezone) selected @endif>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control mydatepicker"
                                                    value="{{ old('billing_start_date') }}" name="billing_start_date"
                                                    data-date-format="mm/dd/yy"></div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control mydatepicker01"
                                                    value="{{ old('billing_end_date') }}" name="billing_end_date"></div>
                                            @if ($errors->first('billing_start_date'))
                                                <div class="mb-1 text-danger">
                                                    {{ $errors->first('billing_start_date') }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <select class="form-control custom-select" name="notify_renewal_date">
                                                    <option value="1 Week"
                                                        {{ old('notify_renewal_date') == '1 Weeks' ? 'selected' : '' }}>1 Week
                                                    </option>
                                                    <option value="2 Weeks"
                                                        {{ old('notify_renewal_date') == '2 Weeks' ? 'selected' : '' }}>2 Weeks
                                                    </option>
                                                    <option value="3 Weeks"
                                                        {{ old('notify_renewal_date') == '3 Weeks' ? 'selected' : '' }}>3 Weeks
                                                    </option>
                                                    <option value="4 Weeks"
                                                        {{ old('notify_renewal_date') == '4 Weeks' ? 'selected' : '' }}>4 Weeks
                                                    </option>
                                                </select>
                                            </div>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <select class="form-control custom-select" name="sis_connection"
                                                    id="sis_connection">
                                                    <option value="iNow"
                                                        {{ old('sis_connection') == 'iNoew' ? 'selected' : '' }}>iNow</option>
                                                    <option value="Power Schools"
                                                        {{ old('sis_connection') == 'Power Schools' ? 'selected' : '' }}>Power
                                                        Schools</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('sis_api_url') }}" name="sis_api_url"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('sis_username') }}" name="sis_username"></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('sis_password') }}" name="sis_password"></div>
                                        ...
                                        <div class="form-group sis_api_application_key">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('sis_application_key') }}" name="sis_application_key">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('school_sis_contact') }}" name="school_sis_contact">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Title : </label>
                                            <div class=""><input type="text" name="school_sis_contact_title"
                                                    class="form-control" value="{{ old('school_sis_contact_title') }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Email : </label>
                                            <div class=""><input type="text" name="school_sis_contact_email"
                                                    class="form-control" value="{{ old('school_sis_contact_email') }}">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label">Phone # : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('school_sis_contact_phone') }}"
                                                    name="school_sis_contact_phone"></div>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex align-items-end"><input type="text"
                                                    name="internal_zone_api_url" class="form-control"
                                                    value="{{ old('internal_zone_api_url') }}"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Internal District Zone Point of Contact : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    name="internal_zone_point_contact"
                                                    value="{{ old('internal_zone_point_contact') }}"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Title : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('internal_zone_point_title') }}"
                                                    name="internal_zone_point_title"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Email : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('internal_zone_point_email') }}"
                                                    name="internal_zone_point_email"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Phone # : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('internal_zone_point_phone') }}"
                                                    name="internal_zone_point_phone"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('external_organization_name') }}"
                                                    name="external_organization_name"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">URL : </label>
                                            <div class="d-flex align-items-end"><input type="text"
                                                    class="form-control" name="external_organization_url"
                                                    value="{{ old('external_organization_url') }}"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">External Organization Zone API Point of Contact :
                                            </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('external_organization_point_contact') }}"
                                                    name="external_organization_point_contact"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Title : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('external_organization_point_title') }}"
                                                    name="external_organization_point_title"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Email : </label>
                                            <div class=""><input type="email" class="form-control"
                                                    value="{{ old('external_organization_point_email') }}"
                                                    name="external_organization_point_email"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Phone # : </label>
                                            <div class=""><input type="text" class="form-control"
                                                    value="{{ old('external_organization_point_phone') }}"
                                                    name="external_organization_point_phone"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-6">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group d-flex justify-content-between pt-5">
                                            ...
                                            <div class="">
                                                <input id="chk_55" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="lottery_number_display" checked />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Desegregation Compliance Active :
                                            </label>
                                            <div class="">
                                                <input id="chk_02" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="desegregation_compliance" checked />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Zone Requirements Active :
                                            </label>
                                            <div class=""><input id="chk_0" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="zone_requirements" checked /></div>
                                        </div>
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Birthday Cutoff Requirements
                                                Active : </label>
                                            <div class=""><input id="chk_01" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="birthday_cutoff_requirement" checked /></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Zone API (Non-Current Students) :
                                            </label>
                                            <div class=""><input id="chk_03" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="zone_api" checked /></div>
                                        </div>
                                        <div id="mcpss_zone">
                                            <div class="form-group justify-content-between d-flex">
                                                <label for="" class="control-label">MCPSS Employee Zone API :
                                                </label>
                                                <div class=""><input type="checkbox"
                                                        class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                        name="mcpss_zone_api" checked /></div>
                                            </div>
                                        </div>
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Zone API (Current Students) :
                                            </label>
                                            <div class=""><input id="chk_0333" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="zone_api_existing" /></div>
                                        </div>
                                        <div class="form-group d-flex justify-content-between">
                                            <label for="" class="control-label">Zone API (Admin Submissions) :
                                            </label>
                                            <div class=""><input id="chk_0334" type="checkbox"
                                                    class="js-switch js-switch-1 js-switch-xs" data-size="Small"
                                                    name="admin_mcpss_zone_api" /></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card shadow">
        ...
        <div class="box content-header-floating" id="listFoot">
            <div class="row">
                <div class="col-lg-12 text-right hidden-xs float-right">
                    <button type="Submit" class="btn btn-warning btn-xs submit"><i class="fa fa-save"></i> Save
                    </button>
                    ...
                    <a class="btn btn-danger btn-xs" href="{{ url('/admin/District') }}"><i class="fa fa-times"></i>
                        Cancel</a>
                </div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            $("input[name='name']").on('input', function() {
                $("input[name='district_slug']").val($(this).val().toLowerCase().trim().replace(
                    /[^a-z0-9\s]/gi, '').replace(/\s{1,}/g, '-'));
            });
            $("input[name='district_slug']").on('input', function() {
                $(this).val($(this).val().toLowerCase().trimStart().replace(/\s{1,}/g, '-').replace(
                    /-{2,}/g, '-').replace(/[^a-z0-9-]/gi, ''));
            });
