        ...
        <div class="card shadow">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class=""><input type="text" name="name" class="form-control"
                            value="{{ old('name') }}"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-7"><input name="logo" type="file" class="form-control"
                                value="{{ old('logo') }}" accept="image/*"></div>
                        <div class="col-12 col-md-5">
                            <div class=" ">
                                <img src="" alt="img" title="" width="70" id="img"
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex align-items-end"><input type="text" name="url" id="url"
                            class="form-control" value="{{ old('url') }}">.magent.com</div>
                    @if ($errors->first('url'))
                        <div class="mb-1 text-danger">
                            {{ $errors->first('url') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" value="{{ old('address') }}"
                            name="address"></div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" value="{{ old('city') }}"
                            name="city"></div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" value="{{ old('state') }}"
                            name="state"></div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" id="zip_code"
                            value="{{ old('zip_code') }}" name="zip_code" maxlength="6"></div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input type="text" class="form-control" value="{{ old('phone') }}"
                            name="phone" maxlength="13"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        <div class="input-group mb-3">
                            <input id="cp2" type="text" class="form-control" value="#2FB6FF" name="theme_color"
                                maxlength="7">
                            <div class="input-group-append">
                                <span class="input-group-text"><i id="chgcolor" class="color-box"
                                        style="background-color: #2FB6FF;"></i></span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class=""><input id="chk_0" type="checkbox" class="js-switch js-switch-1 js-switch-xs"
                            data-size="Small" checked name="status" /></div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(function() {
            ...
            $("input[name='name']").on('input', function() {
                $("input[name='url']").val($(this).val().toLowerCase().trim().replace(/[^a-z0-9\s]/gi, '')
                    .replace(/\s{1,}/g, '-'));
            });
