...
@section('title')Late Submission Process Selection | {{config('app.name',env("APP_NAME"))}} @endsection
@section('content')
...
<script type="text/javascript">
    ...
    $("#selectform_settings").click(function()
    {
        ...
        @else
            document.location.href = "{{url('/admin/LateSubmission/Process/Selection/')}}/"+$("#form_field").val();
        @endif
