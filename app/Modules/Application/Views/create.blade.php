...
@section('title')
    Add Application Dates | {{ config('app.name', env('APP_NAME')) }}
@endsection
    ...
    <form action="{{ url('admin/Application/store') }}" method="post" name="add_application">
        ...
        <ul class="nav nav-tabs" id="myTab2" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" id="cdi-grade-confirm-tab" data-toggle="tab" href="#cdi-grade-confirm"
                    ...
                    Screen</a></li>
            <li class="nav-item"><a class="nav-link" id="sms-text-tab" data-toggle="tab" href="#sms-text" role="tab"
                    aria-controls="sms-text" aria-selected="false">SMS Text</a></li>
        </ul>
        <div class="tab-content bordered" id="myTab2Content">
                    ...
                    <div class="row">
                                    ...
                                    <select class="form-control custom-select" name="form_id">
                                        ...
                                        @forelse($forms as $key=>$form)
                                            <option value="{{ $form->id }}"
                                                {{ old('form_id') == $form->id ? 'selected' : '' }}>{{ $form->name }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-append date form_datetime">
                                    <input class="form-control datetimepicker" name="starting_date" id="starting_date"
                                        value="{{ old('starting_date') }}" disabled=""
                                        data-date-format="mm/dd/yyyy hh:ii" {{-- readonly="readonly" --}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control datetimepicker" name="ending_date" id="ending_date"
                                        value="{{ old('ending_date') }}" disabled=""
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-append date form_datetime">
                                    <input class="form-control datetimepicker" name="admin_starting_date"
                                        id="admin_starting_date" value="{{ old('admin_starting_date') }}" disabled=""
                                        data-date-format="mm/dd/yyyy hh:ii" {{-- readonly="readonly" --}}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control datetimepicker" name="admin_ending_date"
                                        id="admin_ending_date" value="{{ old('admin_ending_date') }}" disabled=""
                                        data-date-format="mm/dd/yyyy hh:ii">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control datetimepicker" name="recommendation_due_date"
                                        ...
                                        value="{{ old('recommendation_due_date') }}" data-date-format="mm/dd/yyyy hh:ii">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control datetimepicker" name="writing_prompt_due_date"
                                        ...
                                        value="{{ old('writing_prompt_due_date') }}" data-date-format="mm/dd/yyyy hh:ii">
                                </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input class="form-control datetimepicker" name="transcript_due_date"
                                        id="transcript_due_date" disabled value="{{ old('transcript_due_date') }}"
                                        data-date-format="mm/dd/yyyy hh:ii">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <select class="form-control custom-select" name="valid_for">
                                        <option value="current" {{ old('valid_for') == 'current' ? 'selected' : '' }}>Only
                                            Current</option>
                                        <option value="non-current" {{ old('valid_for') == 'not-current' ? 'selected' : '' }}>
                                            Only Not Current</option>
                                        <option value="both"
                                            {{ !in_array(old('valid_for'), ['current', 'non-current']) ? 'selected' : '' }}>
                                            Both</option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @forelse($program['grade_info'] as $key=>$grade)
                                        <div class="">
                                            <div class="custom-control custom-checkbox custom-control-inline">
                                                <input type="checkbox" id="{{ $grade['id'] }}{{ $program['id'] }}"
                                                    name="program_grade_id[]" class="custom-control-input"
                                                    value="{{ $program['id'] }},{{ $grade['id'] }}"
                                                    {{-- {{is_array(old('program_grade_id')) && in_array($program['id'].",".$grade['id'], old('program_grade_id'))?'checked':''}} --}} checked>
                                                <label class="custom-control-label"
                                                    for="{{ $grade['id'] }}{{ $program['id'] }}">{{ $program['name'] }}
                                                    - {{ $grade['name'] }}</label>
                                            </div>
                                        </div>
                                    @empty
                ...
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_title"
                            value="Your Magnet Program application has been successfully submitted!">
                    </div>
                </div>
                <div class="form-group">
                    <label>Active Screen Subject : </label>
                    <div class="editor-height-210">
                        <input type="text" class="form-control" class="form-control" name="active_screen_subject"
                            value="Your Confirmation Number# <br> {confirm_number}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        ...
                        <p>Please direct all questions about the HCS Magnet Application to the Office of Magnet Program at xxx@xxx.org or by calling 123-456-7890 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>
                    </textarea>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade" id="active-email" role="tabpanel" aria-labelledby="active-email-tab">
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" name="active_email_subject" class="form-control"
                            name="active_email_subject" value="Your HCS Magnet Application # {confirm_number}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        ...
                        <p>Your Application Status is <strong>Active.</strong><br />
                            ...
                            <p>Please direct all questions about the HCS Magnet Application to the Office of Magnet Program at xxx@xxxx.org or by calling 123-456-7890 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>

                            <p>The office of Magnet Programs is located at Jefferson Co. County Schools</p>
                    </textarea>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade" id="active1-email" role="tabpanel" aria-labelledby="active1-email-tab">
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        ...
                        <p>In order to complete the application process, you must submit a copy of your student's grades and discipline records by {transcript_due_date}. These records should be emailed to xxx@xxx.org. Please include your confirmation number in your email.</p>

                        <p>Please print this page and/or record this confirmation number for your records. If you provided an email address, you will receive an email confirmation at the email address provided. &nbsp;</p>

                        <p>Please direct all questions about the Jefferson Magnet Application to the Office of Magnet Program at xxx@xxxx.org or by calling 123-456-7890 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>
            ...
            <div class="tab-pane fade" id="active2-email" role="tabpanel" aria-labelledby="active2-email-tab">
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <input type="text" class="form-control" name="active_email_subject" class="form-control"
                            name="pending_email_subject" value="Your Pending Confirmation Number# <br> {confirm_number}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        ...
                        <p>Your application status is <strong>Pending.</strong><br />
                            <br />
                            Your Magnet Program application has been successfully submitted!&nbsp; In order to complete the application process, you must submit a copy of your student's grades and discipline records by {transcript_due_date}. These records should be emailed to xxx@xxx.org. Please include your confirmation number in your email.</p>

                            <p>Please direct all questions about the Jefferson Magnet Application to the Office of Magnet Program at xxx@xxx.org or by calling 256-428-6987 between the hours of 8:30 am and 4:00 pm Monday through Friday.</p>
            ...
            <div class="tab-pane fade" id="cdi-grade-upload" role="tabpanel" aria-labelledby="cdi-grade-upload-tab">
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <textarea class="form-control editor" id="grade_cdi_welcome_text" name="grade_cdi_welcome_text">
            ...
            <div class="tab-pane fade" id="sms-text" role="tabpanel" aria-labelledby="sms-text-tab">
                <div class="form-group">
                    <label for="sms_text">SMS Text</label>
                    <div class="">
                        <textarea class="form-control" id="sms_text" name="sms_text" rows="6"
                            placeholder="Enter SMS text message..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="cdi-grade-confirm" role="tabpanel" aria-labelledby="cdi-grade-confirm-tab">
                <div class="form-group">
                    ...
                    <div class="editor-height-210">
                        <textarea class="form-control editor" id="grade_cdi_confirm_text" name="grade_cdi_confirm_text">
                        <main>
                            <div class="container">
                                <div class="mt-20">
            ...
            <div class="box content-header-floating" id="listFoot">
                <div class="row">
                    <div class="col-lg-12 text-right hidden-xs float-right">
                        ...
                        <button type="submit" name="save_exit" value="save_exit" class="btn btn-success btn-xs submit"
                            title="Save & Exit"><i class="fa fa-save"></i> Save &amp; Exit</button>
