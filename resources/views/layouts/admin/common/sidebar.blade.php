...
<div class="left side-menu" datasidebar-bg="theme05">
    <div class="">
        <div class="border-bottom d-flex align-items-center"
            ...
            <div class="logo-box p-10 text-center"> <a href="{{ url('/admin/dashboard') }}" title=""
                    class="logo-dark h-100"><img class="img-fluid h-100" src="{{ getDistrictLogo() }}" title=""
                        alt="" width="200"></a> <a href="{{ url('/admin/dashboard') }}" title=""
                    class="logo-dark-small h-100"><img class="img-fluid h-100" src="{{ getDistrictLogo() }}"
                        title="" alt=""></a> <a href="{{ url('/admin/dashboard') }}" title=""
                    class="logo-light h-100"><img class="img-fluid h-100" src="{{ getDistrictLogo() }}" title=""
                        alt=""></a> <a href="{{ url('/admin/dashboard') }}" title=""
                    class="logo-light-small h-100"><img class="img-fluid h-100" src="{{ getDistrictLogo() }}"
                        title="" alt=""></a> </div>
    ...
    <div class="slimscroll-menu" id="remove-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul id="side-menu">
                <li
                    class="{{ Request::is('admin/dashboard') || Request::is('admin/magnet_dashboard*') || Request::is('admin/superadmin/offer') || Request::is('admin/districtadmin/offer') ? 'mm-active' : '' }}">
                    <a title="Dashboard" href="{{ url('/admin/dashboard') }}"
                        class="{{ Request::is('admin/dashboard') || Request::is('admin/magnet_dashboard*') || Request::is('admin/superadmin/offer') || Request::is('admin/districtadmin/offer') ? 'active' : '' }}"><i
                            class="far fa-chart-bar"></i><span>Dashboard</span></a>
                </li>
                @if (checkPermission(Auth::user()->role_id, 'Submissions') == 1)
                    <li
                        class="{{ Request::is('admin/Submissions*') || Request::is('admin/Submissions/edit*') || Request::is('admin/CustomCommunication*') || Request::is('admin/GenerateApplicationData*') || Request::is('admin/GenerateApplicationData/generated') || Request::is('admin/Reports/admin_review*') || Request::is('admin/Reports/missing/15/gradecdiupload*') || Request::is('admin/Reports/export/submissions*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="nav-second-level {{ Request::is('admin/Submissions*') || Request::is('admin/Submissions/edit*') || Request::is('admin/CustomCommunication*') || Request::is('admin/GenerateApplicationData*') || Request::is('admin/GenerateApplicationData/generated') || Request::is('admin/Reports/admin_review*') || Request::is('admin/Reports/missing/15/gradecdiupload*') || Request::is('admin/Reports/export/submissions*') ? 'mm-show' : '' }}"
                            aria-expanded="false">
                            <li
                                class="{{ Request::is('admin/Submissions*') || Request::is('admin/Submissions/edit*') ? 'mm-active' : '' }}">
                                <a title="Submissions" href="{{ url('/admin/Submissions') }}"
                                    class="{{ Request::is('admin/Submissions*') || Request::is('admin/Submissions/edit*') ? 'active' : '' }}">
                            ...
                            <li
                                class="{{ (Request::is('admin/GenerateApplicationData') && !Request::is('admin/GenerateApplicationData/*')) || Request::is('admin/GenerateApplicationData/generated') ? 'mm-active' : '' }}">
                                <a title="Generate Application Data" href="{{ url('/admin/GenerateApplicationData') }}"
                                    class="{{ (Request::is('admin/GenerateApplicationData') && !Request::is('admin/GenerateApplicationData/*')) || Request::is('admin/GenerateApplicationData/generated') ? 'active' : '' }}">
                ...
                @if (checkPermission(Auth::user()->role_id, 'Availability') == 1)
                    <li
                        class="{{ Request::is('admin/Availability*') || Request::is('admin/Process/Selection*') || Request::is('admin/Process/Selection/Population/Application*') || Request::is('admin/Process/Selection/Results/Application*') || Request::is('admin/Process/Selection/step2*') || Request::is('admin/Preliminary/Processing*') || Request::is('admin/EditCommunication*') || Request::is('admin/DistrictConfiguration/edit_text*') || Request::is('admin/DistrictConfiguration/edit_email*') || Request::is('admin/Process/Selection/statereport*') ? 'mm-active' : '' }}">
                        ...
                        <ul class="nav-second-level {{ Request::is('admin/Availability*') || Request::is('admin/Process/Selection*') || Request::is('admin/Process/Selection/Population/Application*') || Request::is('admin/Process/Selection/Results/Application*') || Request::is('admin/Process/Selection/step2*') || Request::is('admin/Preliminary/Processing*') || Request::is('admin/EditCommunication*') || Request::is('admin/DistrictConfiguration/edit_text*') || Request::is('admin/DistrictConfiguration/edit_email*') || Request::is('admin/Process/Selection/statereport*') ? 'mm-show' : '' }}"
                            aria-expanded="false">
                            ...
                            <li
                                class="{{ Request::is('admin/Process/Selection') || Request::is('admin/Process/Selection/step2*') || Request::is('admin/Process/Selection/Population/Application*') || Request::is('admin/Process/Selection/Results/Application*') ? 'mm-active' : '' }}">
                                <a title="Process Selection" href="{{ url('/admin/Process/Selection/') }}"
                                    class="{{ Request::is('admin/Process/Selection') || Request::is('admin/Process/Selection/step2*') || Request::is('admin/Process/Selection/Population/Application*') || Request::is('admin/Process/Selection/Results/Application*') ? 'active' : '' }}">
                            ...
                            <li class="{{ Request::is('admin/Process/Selection/statereport*') ? 'mm-active' : '' }}">
                                <a title="Current State Report"
                                    href="{{ url('/admin/Process/Selection/statereport') }}"
                                    class="{{ Request::is('admin/Process/Selection/statereport*') ? 'active' : '' }}"><span>Current
                                        State Report</span></a>
                            </li>
                        </ul>
                    </li>
                @endif
                <li
                    class="{{ Request::is('admin/Waitlist*') || Request::is('admin/Waitlist/Process/Selection*') || Request::is('admin/DistrictConfiguration/edit_waitlist_text*') || Request::is('admin/DistrictConfiguration/edit_waitlist_email*') ? 'mm-active' : '' }}">
                    ...
                    <ul class="nav-second-level {{ Request::is('admin/Waitlist*') || Request::is('admin/Waitlist/Process/Selection*') || Request::is('admin/DistrictConfiguration/edit_waitlist_text*') || Request::is('admin/DistrictConfiguration/edit_waitlist_email*') ? 'mm-show' : '' }}"
                        aria-expanded="false">
                        <li
                            class="{{ Request::is('admin/Waitlist') || Request::is('admin/Waitlist/Process/Selection*') ? 'mm-active' : '' }}">
                            <a title="Run Selection" href="{{ url('/admin/Waitlist') }}"
                                class="{{ Request::is('admin/Waitlist') || Request::is('admin/Waitlist/Process/Selection*') ? 'active' : '' }}">
                                <span>Run Selection</span>
                            </a>
                        </li>
                ...
                <li
                    class="{{ Request::is('admin/LateSubmission*') || Request::is('admin/LateSubmission/Process/Selection*') || Request::is('admin/DistrictConfiguration/edit_late_submission_text*') || Request::is('admin/DistrictConfiguration/edit_late_submission_email*') ? 'mm-active' : '' }}">
                    ...
                    <ul class="nav-second-level {{ Request::is('admin/LateSubmission*') || Request::is('admin/LateSubmission/Process/Selection*') || Request::is('admin/DistrictConfiguration/edit_late_submission_text*') || Request::is('admin/DistrictConfiguration/edit_late_submission_email*') ? 'mm-show' : '' }}"
                        aria-expanded="false">
                        <li
                            class="{{ Request::is('admin/LateSubmission') || Request::is('admin/LateSubmission/Process/Selection*') ? 'mm-active' : '' }}">
                            <a title="Run Selection" href="{{ url('/admin/LateSubmission') }}"
                                class="{{ Request::is('admin/LateSubmission') || Request::is('admin/LateSubmission/Process/Selection*') ? 'active' : '' }}">
                                <span>Run Selection</span>
                            </a>
                        </li>
                ...
                @if (checkPermission(Auth::user()->role_id, 'Reports/missing/grade') == 1 ||
                    ...
                    <li
                        class="{{ Request::is('admin/Reports/missing*') && !Request::is('admin/Reports/missing/15/gradecdiupload*') ? 'mm-active' : '' }}">
                        <a title="Reports" href="{{ url('/admin/Reports/missing') }}"
                            class="{{ Request::is('admin/Reports/missing*') && !Request::is('admin/Reports/missing/15/gradecdiupload*') ? 'active' : '' }}">
                            <i class="far fa-file-alt"></i>
                            <span>Reports</span>
                        </a>
                    </li>
                ...
                @if (checkPermission(Auth::user()->role_id, 'Configuration') == 1 || Auth::user()->role_id == 2)
                    <li
                        class="{{ Request::is('admin/Reports/process/logs*') || Request::is('admin/Reports/process/real/logs*') || Request::is('admin/Files*') || Request::is('admin/Configuration*') || Request::is('admin/AuditTrailData*') || Request::is('admin/DistrictConfiguration') || Request::is('admin/Users*') || Request::is('admin/ZonedSchool/overrideAddress*') || Request::is('admin/ZonedSchool/create') || Request::is('admin/ZonedSchool/edit*') || Request::is('admin/GiftedStudents*') || Request::is('admin/import/agt_nch*') || Request::is('admin/StudentSearch*') || Request::is('admin/import/non_jcs_students*') || Request::is('admin/ReturningStudent*') || Request::is('admin/ManualSelection/pre_req*') ? 'mm-active' : '' }}">
                        <a title="Configuration" href="javascript:void(0);"
                            class="{{ Request::is('admin/Reports/process/logs*') || Request::is('admin/Reports/process/real/logs*') || Request::is('admin/Files*') || Request::is('admin/Configuration*') || Request::is('admin/AuditTrailData*') || Request::is('admin/DistrictConfiguration') || Request::is('admin/Users*') || Request::is('admin/ZonedSchool/overrideAddress*') || Request::is('admin/ZonedSchool/create') || Request::is('admin/ZonedSchool/edit*') || Request::is('admin/GiftedStudents*') || Request::is('admin/import/agt_nch*') || Request::is('admin/StudentSearch*') || Request::is('admin/import/non_jcs_students*') || Request::is('admin/ReturningStudent*') || Request::is('admin/ManualSelection/pre_req*') ? 'mm-active' : '' }}">
                            <i class="fas fa-cog"></i><span>Administration</span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level {{ Request::is('admin/Reports/process/logs*') || Request::is('admin/Reports/process/real/logs*') || Request::is('admin/Files*') || Request::is('admin/Configuration*') || Request::is('admin/AuditTrailData*') || Request::is('admin/DistrictConfiguration') || Request::is('admin/Users*') || Request::is('admin/ZonedSchool/overrideAddress*') || Request::is('admin/ZonedSchool/create') || Request::is('admin/ZonedSchool/edit*') || Request::is('admin/GiftedStudents*') || Request::is('admin/import/agt_nch*') || Request::is('admin/StudentSearch*') || Request::is('admin/import/non_jcs_students*') || Request::is('admin/ReturningStudent*') || Request::is('admin/ManualSelection/pre_req*') ? 'mm-show' : '' }}"
                            aria-expanded="false">
                            ...
                            <li class="{{ Request::is('admin/ZonedSchool/overrideAddress*') || Request::is('admin/ZonedSchool/create') || Request::is('admin/ZonedSchool/edit*') ? 'mm-active' : '' }}"><a
                                    title="Address Override" href="{{ url('/admin/ZonedSchool/overrideAddress') }}"
                                    class="{{ Request::is('admin/ZonedSchool/overrideAddress*') || Request::is('admin/ZonedSchool/create') || Request::is('admin/ZonedSchool/edit*') ? 'active' : '' }}"><span>Address
                                        Override</span></a></li>
                            ...
                            <li class="d-none {{ Request::is('admin/GiftedStudents*') ? 'mm-active' : '' }}">
                            ...
                            <li class="d-none {{ Request::is('admin/import/agt_nch*') ? 'mm-active' : '' }}">
                            ...
                            <li class="{{ Request::is('admin/import/non_jcs_students*') ? 'mm-active' : '' }}"><a
                                    title="Import Non JCS Student"
                                    href="{{ url('/admin/import/non_jcs_students') }}"
                                    class="{{ Request::is('admin/import/non_jcs_students*') ? 'active' : '' }}"><span>Import
                                        Non JCS
                                        Students</span></a></li>
                            <li class="{{ Request::is('admin/ReturningStudent*') ? 'mm-active' : '' }}"><a
                                    title="Import Returning Students" href="{{ url('/admin/ReturningStudent') }}"
                                    class="{{ Request::is('admin/ReturningStudent*') ? 'active' : '' }}"><span>Import
                                        Returning
                                        Students</span></a></li>
                            <li class="{{ Request::is('admin/ManualSelection/pre_req*') ? 'mm-active' : '' }}"><a
                                    title="Build Program Pre-req Report"
                                    href="{{ url('/admin/ManualSelection/pre_req') }}"
                                    class="{{ Request::is('admin/ManualSelection/pre_req*') ? 'active' : '' }}"><span>Program
                                        Prerequisites
                                        Settings</span></a></li>
                ...
                @if (Auth::user()->role_id == 1)
                    <li
                        ...
                        <ul class="nav-second-level {{ Request::is('admin/District*') || Request::is('admin/Program*') || Request::is('admin/Eligibility*') || Request::is('admin/School*') || Request::is('admin/Priority*') || Request::is('admin/Reports') || Request::is('admin/Waitlist/Admin/Selection*') || Request::is('admin/LateSubmission/Admin/Selection*') || Request::is('admin/Form*') || Request::is('admin/Reports/Waitlist*') || Request::is('admin/Role*') || Request::is('admin/ZonedSchool*') || Request::is('admin/ConfigureExportSubmission*') || Request::is('admin/EligibilityChecker*') ? 'mm-show' : '' }}"
                            ...
                            <li
                                class="{{ Request::is('admin/Eligibility*') && !Request::is('admin/EligibilityChecker*') ? 'mm-active' : '' }}">
                                <a title="Eligibility Master" href="{{ url('/admin/Eligibility') }}"
                                    class="{{ Request::is('admin/Eligibility*') && !Request::is('admin/EligibilityChecker*') ? 'active' : '' }}">
