                ...
                @if((checkPermission(Auth::user()->role_id,'Availability') == 1))
                    <li>
                        ...
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li class=""><a title="Program Max Percent Swing" href="{{url('/admin/Process/Selection/settings')}}" class="active"><span>Program Max Percent Swing</span></a></li>
                             <li class="d-none"><a title="Preliminary Processing" href="{{url('/admin/Preliminary/Processing')}}"><span>Preliminary Processing</span></a></li> 
                             <li class=""><a title="Process Selection" href="{{url('/admin/Process/Selection/')}}"><span>Run Selection</span></a></li> 
                             <li class=""><a title="Edit Communication" href="{{url('/admin/EditCommunication')}}"><span>Edit Communication</span></a></li> 
                             <li class=""><a title="Edit Screen Text" href="{{url('/admin/DistrictConfiguration/edit_text')}}"><span>Edit Screen Text</span></a></li> 
                             <li class=""><a title="Edit Final Confirmation Email" href="{{url('/admin/DistrictConfiguration/edit_email')}}"><span>Edit Final Confirmation Email</span></a></li> 
                             <li class=""><a title="Current State Report" href="{{url('/admin/Process/Selection/statereport')}}" class="active"><span>Current State Report</span></a></li>
                ...
                @if(checkPermission(Auth::user()->role_id,'Configuration') == 1 || Auth::user()->role_id == 2)
                    <li class=""><a title="Configuration" href="javascript:void(0);"><i class="fas fa-cog"></i><span>Administration</span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            <li class="d-none"><a title="Gifted Students" href="{{url('/admin/GiftedStudents')}}"><span>Gifted Students</span></a></li>
                            <li class="d-none"><a title="Import Student Data for Program" href="{{url('/admin/import/agt_nch')}}"><span>Import Student Data for Program</span></a></li>
                            <li class=""><a title="Import Non JCS Student" href="{{url('/admin/import/non_jcs_students')}}"><span>Import Non JCS Students</span></a></li>
                            <li class=""><a title="Import Returning Students" href="{{url('/admin/ReturningStudent')}}"><span>Import Returning Students</span></a></li>
                            <li class=""><a title="Build Program Pre-req Report" href="{{url('/admin/ManualSelection/pre_req')}}"><span>Program Prerequisites Settings</span></a></li>
                ...
                @if(Auth::user()->role_id == 1)
                    <li class="master"> <a title="" href="javascript:void(0);"><i class="far fa-gem"></i><span>Master</span> <span class="menu-arrow"></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            ...
                            {{-- <li class=""><a title="Zone Address" href="{{url('/admin/ZonedSchool')}}"><span>Upload School Address</span></a></li> --}}
