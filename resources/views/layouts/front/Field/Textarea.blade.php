<div class="form-group row  @if(isset($data['initial_display']) && $data['initial_display'] == 'yes') d-none @endif" @if(isset($data['field_id']) && $data['field_id'] != '') id="{{$data['field_id']}}" @endif>
	@if(isset($data['label']))
